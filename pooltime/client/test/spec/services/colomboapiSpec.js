(function () {
    ...
    describe('services.colomboapi', function () {
        describe('ColomboAPI', function () {
            ...
            beforeEach(function () {
                ColomboAPIConverter = {
                    convertGamesData: function (data) {
                        this.convertedGames = data;
                        return data;
                    },
                    convertPicksData: function (data) {
        ...
        describe('ColomboAPIConverter', function () {
            ...
            describe('convertGamesData', function () {
                it('should convert the data properly', function () {
                    var result = ColomboAPIConverter.convertGamesData(testData.WEEK_3_GAMES);
            ...
            describe('convertPicksData', function () {
                it('should convert the data properly', function () {
                    var result, joesPicks;
                    result = ColomboAPIConverter.convertPicksData(testData.WEEK_3_PICKS);
